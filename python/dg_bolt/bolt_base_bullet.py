...
class BoltBaseRobot(Robot):
    ...
    """
    def __init__(self, bolt_config, useFixedBase=False, record_video=False,
        ...
        self.device.base_accelerometer.value = 3 * [0.]
        self.device.base_gyroscope.value = 3 * [0.]
        self.device.base_attitude.value = 3 * [0.]
        self.device.base_linear_acceleration.value = 3 * [0.]
        self.device.base_attitude_quaternion.value = 4 * [0.]
