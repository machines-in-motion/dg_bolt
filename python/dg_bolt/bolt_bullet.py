...
class BoltBulletRobot(BoltBaseRobot):
    def __init__(self, useFixedBase=False, record_video=False,
             init_sliders_pose=4*[0.5]):
        super(BoltBulletRobot, self).__init__(BoltConfig(), useFixedBase,
...
def get_bolt_robot(useFixedBase=False, record_video = False,
                   init_sliders_pose=4*[0.5]):
